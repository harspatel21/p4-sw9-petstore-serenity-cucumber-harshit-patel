...
public class UserCRUDTest extends TestBase {
    ...
    static String username = "Raa" + TestUtils.getRandomValue();
    static String firstName = "Ram";
    static String lastName = "Raja";
    static String email = "Raja.Ram" + TestUtils.getRandomValue() + "@email.com";
    static String password = "RajaRam" + TestUtils.getRandomNum();
